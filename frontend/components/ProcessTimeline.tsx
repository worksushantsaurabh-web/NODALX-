...
export default function ProcessTimeline() {
  return (
    <section className="relative py-24 lg:py-32 bg-neutral-50/50 overflow-hidden border-t border-neutral-100">
      {/* Decorative Background */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-full pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-neutral-100/40 rounded-full blur-3xl"></div>
          ...
          {steps.map((step, index) => (
            <React.Fragment key={step.id}>
              ...
              >
                ...
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-neutral-50/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
              ...
              {index < steps.length - 1 && (
                <div 
                  className="flex items-center justify-center text-neutral-300 animate-fade-in-up"
